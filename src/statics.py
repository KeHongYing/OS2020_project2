...
if __name__ == '__main__':
	...
	print('diff_mean:', np.mean(np.abs(master_times - slave_times)))
	print('diff_std:', np.std(np.abs(master_times - slave_times)))
	print('master_mean:', np.mean(master_times))
	print('master_std:', np.std(master_times))
	print('master_filesize:', np.mean(master_filesizes))
	print('master_average_filesize:', np.mean(master_filesizes) / np.mean(master_times))
	print('slave_mean:', np.mean(slave_times))
	print('slave_std:', np.std(slave_times))
	print('slave_filesize:', np.mean(slave_filesizes))
	print('slave_average_filesize:', np.mean(slave_filesizes) / np.mean(slave_times))
